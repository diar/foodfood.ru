...
<xsl:stylesheet version="1.0"
        ...
        <table id="additional">
            <tr id="recomended">
                <td colspan="2" class="additional_left">
                    <div id="recomended_title" class="rounded_right">
                        <div class="text">Стоит попробовать</div>
                        <div id="arrows">
                            <div class="back"></div>
                            <div class="next"></div>
                        </div>
            ...
            <tr class="additional_content" id="additional1_content">
                ...
                <td class="additional_center" id="restaurant_poster">
                    ...
                    <div class="clear"></div>
                    <div class="more">Ещё есть
                        <a href="/{//site/city}/poster">много мероприятий</a>
                    </div>
                </td>
                <td class="additional_right" id="restaurant_discount">
                    ...
                    <div class="discounts">
                        ...
                        <div class="clear"></div>
                        <div class="more">
                            <a href="/{//site/city}/discount">Все скидки</a>
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr class="additional_content" id="additional2_content">
                ...
                <td class="additional_right" id="restaurant_dostavka">
                    <div class="caption rounded_left">
                        <a href="#">On-line заказы</a>
                    </div>
                    <div class="clear"></div>
                    <ul>
    ...
    <xsl:template match="reviews/item">
        <div class="review">
            <div class="from">
                <a href="/blog/profile/{user_login}" class="user">
    ...
    <xsl:template match="blogs/item/item">
        <div class="article">
            <div class="img">
                <xsl:choose>
                    <xsl:when test="blog_avatar!=''">
                        <img src="{blog_avatar}" />
                    </xsl:when>
                    <xsl:otherwise>
                        <img src="/public/images/avatar_48x48.jpg" />
                    </xsl:otherwise>
                </xsl:choose>
            </div>
            <div class="article_text">
                <a class="article_title" href="/blog/restaurant/{blog_url}">
                    <xsl:value-of select="title" />
                </a>
                <div class="text">
