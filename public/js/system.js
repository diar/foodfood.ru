...
// Serialize
function serialize(a){var j=function(c){var f=typeof c,d,h;if(f=="object"&&!c)return"null";if(f=="object"){if(!c.constructor)return"object";c=c.constructor.toString();if(d=c.match(/(\w+)\(/))c=d[1].toLowerCase();d=["boolean","number","string","array"];for(h in d)if(c==d[h]){f=d[h];break}}return f},i=j(a),b,g="";switch(i){case "function":b="";break;case "undefined":b="N";break;case "boolean":b="b:"+(a?"1":"0");break;case "number":b=(Math.round(a)==a?"i":"d")+":"+a;break;case "string":b="s:"+a.length+
':"'+a+'"';break;case "array":case "object":b="a";var k=0,l="",e;for(e in a){g=j(a[e]);if(g!="function"){g=e.match(/^[0-9]+$/)?parseInt(e):e;l+=serialize(g)+serialize(a[e]);k++}}b+=":"+k+":{"+l+"}";break}if(i!="object"&&i!="array")b+=";";return b};
// Md5 хэш
