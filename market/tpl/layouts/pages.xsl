...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="header">
        ...
        <div id="login_block">
            <xsl:choose>
                <xsl:when test="//user/is_auth=1">
                    ...
                    <xsl:text> </xsl:text>
                    <a href="/blog/settings/profile/">профиль</a>
                    <xsl:text> (</xsl:text>
                    <a href="/{//site/city}/auth/logout">выход</a>
                    <xsl:text>)</xsl:text>
                </xsl:when>
                <xsl:otherwise>
        ...
        <div id="moods_container">
            <div id="moods">
                ...
                <div id="cursor_top" class="rounded">
                    <div class="left_text no_text_select">Повеселее</div>
                    <div id="cursor">
                        <div class="scroll_left"></div>
                        <div class="scroll_right"></div>
                    </div>
                    <div class="right_text no_text_select">Посерьёзней</div>
                </div>
            </div>
        </div>
        ...
        <div id="chars_container">
            <div id="chars">
                ...
                <div class="chars_line">
                    ...
                    <div class="center">
                        <div class="items">
                            <xsl:call-template name="chars_list_latin"/>
                        </div>
                    </div>
                    <div class="right"></div>
                </div>
        ...
        <div id="restaurant_by_mood">
            ...
            <div class="clear"></div>
            <xsl:call-template name="restaurant_by_mood_navigate_bottom" />
        </div>
    </xsl:template >
    ...
    <xsl:template name="footer">
        <div id="copyright">
            ...
            <div class="right">
                <a href="/{//site/city}/page/about">О проекте</a>
                <a href="/{//site/city}/page/ads">Реклама</a>
                <a href="http://bpirok.ru" title="Большой пирок">
                    <img src="/public/images/icons/bp_icon.jpg" alt="Большой пирок" />
                </a>
            </div>
        </div>
    </xsl:template>
