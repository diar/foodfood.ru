...
class poster_Page extends View {
    ...
    */
    public static function initController ($action) {
        ...
        self::$page['site']['description'] = 'Fooffood.ru открывает доставку!В любом месте города, в любое время дня и ночи мы готовы накрыть ваш стол. С помощью нашего портала вы можете заказать на дом не только пиццу и суши, но и любое блюдо из понравившегося вам ресторана Казани. А если душа требует не только сытости живота, но и пенного праздника, foodfood.ru привезет к вам в дом свежее и холодное пиво. Доставка еды в Казани от портала foodfood.ru не оставит вас голодными! Мы готовы доставить  вам на дом пиво и пиццу к веселому празднику, изысканные фирменные блюда для романтического вечера, суши и роллы к заморскому перекусу с коллегами.
';
