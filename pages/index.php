...
class index_Page extends View {
    ...
    */
    public static function initController ($action) {
        ...
        self::$page['site']['description'] = "Food food сочетает в себе полноценный ресторанный портал с каталогом ресторанов и сообществом любителей вкусно поесть.
На портале представлены все кафе и рестораны города Казани с меню, фотографиями и отзывами.
На сайте есть возможность заказать банкет, забронировать стол, получить скидку и конечно же представлена доставка еды. Каждому посетителю портала будет доступно в интерактивной форме: Выбор ресторана; Просмотр меню; Афиши; Интерьера;Отзывы и рекомендации; Скидки в кафе и ресторане; Доставка блюд. ";
