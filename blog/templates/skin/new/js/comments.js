var lsCmtTreeClass = new Class({
    ...
    typeComment: {
        topic: {
            url_add: aRouter.restaurant+'ajaxaddcomment/',
    ...
    expandNode: function(img) {
        var thisObj = this;
        img.setProperties({
            'src': this.options.img.path + this.options.img.closeName
            });
    ...
    collapseNode: function(img) {
        var thisObj = this;
        img.setProperties({
            'src': this.options.img.path + this.options.img.openName
            });
