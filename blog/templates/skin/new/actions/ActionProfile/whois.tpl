    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{router page='restaurant'}{$oBlog->getUrl()}/">{$oBlog->getTitle()|escape:'html'}</a>{if !$smarty.foreach.blog_owner.last}, {/if}
        					{/foreach}
            </td>
        </tr>
					{/if}
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{router page='restaurant'}{$oBlog->getUrl()}/">{$oBlog->getTitle()|escape:'html'}</a>{if !$smarty.foreach.blog_user.last}, {/if}
							{/foreach}
            </td>
        </tr>
					{/if}
