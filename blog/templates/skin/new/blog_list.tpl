				<table>
					...
					<tbody>
						...
						<tr>
							<td class="name">
								<a href="{router page='restaurant'}{$oBlog->getUrl()}/"><img src="{$oBlog->getAvatarPath(24)}" alt="" /></a>
								<a href="{router page='restaurant'}{$oBlog->getUrl()}/" class="title {if $oBlog->getType()=='close'}close{/if}">{$oBlog->getTitle()|escape:'html'}</a><br />
