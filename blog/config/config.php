...
$config['view']['name']        = 'FoodFood - ресторанный портал №1';                   // название сайта
$config['view']['description'] = 'FoodFood - ресторанный портал №1'; // seo description
$config['view']['keywords']    = 'Казань, рестораны';      // seo keywords
...
$config['sys']['mail']['from_email']       = 'info@foodfood.ru'; // Мыло с которого отправляются все уведомления
$config['sys']['mail']['from_name']        = 'FoodFood';  // Имя с которого отправляются все уведомления
...
$config['db']['table']['session']             = 'session';
