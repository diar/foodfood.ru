...
class ActionProfile extends Action {
	...
	protected function RegisterEvent() {			
		...
		$this->AddEventPreg('/^[\wА-Яа-я\-\_]+$/iu','/^(whois)?$/i','EventWhois');
		$this->AddEventPreg('/^[\wА-Яа-я\-\_]+$/iu','/^favourites$/i','/^comments$/i','/^(page(\d+))?$/i','EventFavouriteComments');
		$this->AddEventPreg('/^[\wА-Яа-я\-\_]+$/iu','/^favourites$/i','/^(page(\d+))?$/i','EventFavourite');
	}
