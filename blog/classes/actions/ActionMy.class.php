...
class ActionMy extends Action {
	...
	protected function RegisterEvent() {	
		$this->AddEventPreg('/^[\wА-Яа-я\-\_]+$/iu','/^(page(\d+))?$/i','EventTopics');
		$this->AddEventPreg('/^[\wА-Яа-я\-\_]+$/iu','/^blog$/i','/^(page(\d+))?$/i','EventTopics');
		$this->AddEventPreg('/^[\wА-Яа-я\-\_]+$/iu','/^comment$/i','/^(page(\d+))?$/i','EventComments');
	}
